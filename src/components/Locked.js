...
function SvgLocked() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 32 32">
            <path
                d="M13.172 7.172A4 4 0 0120 10v3h-8v-3a4 4 0 011.172-2.828zM10 13v-3a6 6 0 1112 0v3h1c1.807 0 3 1.67 3 3.364v8.272C26 26.331 24.807 28 23 28H9c-1.807 0-3-1.67-3-3.364v-8.272C6 14.669 7.193 13 9 13h1zm11 2H9c-.402 0-1 .447-1 1.364v8.272C8 25.553 8.598 26 9 26h14c.402 0 1-.447 1-1.364v-8.272c0-.917-.598-1.364-1-1.364h-2z"
                clipRule="evenodd"
            />
        </svg>
    );
