...
function SvgEdit2() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 32 32">
            <g className="edit-2_svg__edit-2">
                <path
                    d="M23.117 7.323a1.103 1.103 0 111.56 1.56l-9.223 9.223-2.08.52.52-2.08 9.223-9.223zM23.897 5c-.823 0-1.612.327-2.194.909l-9.419 9.418a.999.999 0 00-.263.465l-.991 3.966a1 1 0 001.213 1.212l3.965-.991a.999.999 0 00.465-.263l9.418-9.419A3.103 3.103 0 0023.897 5zM8 7a3 3 0 00-3 3v14a3 3 0 003 3h14a3 3 0 003-3v-7a1 1 0 10-2 0v7a1 1 0 01-1 1H8a1 1 0 01-1-1V10a1 1 0 011-1h7a1 1 0 100-2H8z"
                    className="edit-2_svg__Union"
                    clipRule="evenodd"
                />
            </g>
        </svg>
