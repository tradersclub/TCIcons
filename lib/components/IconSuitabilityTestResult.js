...
const IconSuitabilityTestResult = (props) => {
    ...
    return React.createElement('object', { style: props.style, dangerouslySetInnerHTML: { __html: `
                    <svg width="${(_a = props.width) !== null && _a !== void 0 ? _a : props.size}" height="${(_b = props.width) !== null && _b !== void 0 ? _b : props.height}" viewBox="0 0 85 81" fill="${props.color}" xmlns="http://www.w3.org/2000/svg">
...
<rect x="37.873" y="50.6248" width="${(_e = props.width) !== null && _e !== void 0 ? _e : props.size}" height="${(_f = props.width) !== null && _f !== void 0 ? _f : props.height}" rx="7" stroke="#33BFFF" stroke-width="${(_g = props.width) !== null && _g !== void 0 ? _g : props.size}" stroke-linecap="round" stroke-linejoin="round"/>
